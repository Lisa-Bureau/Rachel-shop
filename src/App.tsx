...
function App() {
  const [panier, setPanier] = useState<productType[]>([]); // panier = tableau qui contient les produits ajoutés / setPanier = fonction qui permet de modifier le panier 
  
  // on crée une fonction qui s'appelle newPanier pour pouvoir le mettre à jour selon un nouvel Article (newArticle)
  function newPanier(newArticle : productType) { 
